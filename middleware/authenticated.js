...
function routesAdmin (path, redirect) {
  ...
  if (path.match(/\/administracion\/moderar/ig)) {
    return redirect('/')
  }
  ...
  // Nuevo y Editar
  if (path.match(/\/administracion\/emprendedores/ig)) {
    return redirect('/')
  }
  ...
  if (path.match(/^\/administracion$/i) || path.match(/^\/administracion\/$/i)) {
    return redirect('/')
  }
  ...
  if (path.match(/\/administracion\/categorias/gi)) {
    return redirect('/')
  }
...
function routesSuperAdmin (path, redirect) {
  ...
  if (path.match(/\/administracion\/administradores/gi)) {
    return redirect('/')
  }
}
