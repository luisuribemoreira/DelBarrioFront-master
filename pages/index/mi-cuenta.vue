          ...
          <form @submit.prevent="validateBeforeSubmit">
            ...
            <div v-if="loggedUser.rol === 102">
              ...
              <div class="form-group margin-top">
                ...
                <input v-validate data-vv-rules="min:9|numeric|max:9" data-vv-as="telefono" name="telefono" type="number" v-model="user.persona.contacto.Telefono[0].DESC_CONTACTO" class="form-control"/>
              ...
              <div class="form-group margin-top">
                ...
                <input v-validate data-vv-rules="required|numeric|min:9|max:9" data-vv-as="celular" name="celular" type="number" v-model="user.persona.contacto.Celular[0].DESC_CONTACTO" class="form-control"/>
