      ...
      <div class="row">
        <div class="col-lg-4 offset-md-4 col-md-6 offset-sm-3 py-1">
          <div class="input-group">
            <input class="form-control border border-right-0" name="search" v-model.trim="search" placeholder="Buscar por Motivo de Denuncia..." autocomplete="off" autofocus="autofocus" type="text" @keyup="buscador()">
            ...
            switch (this.type) {
              case 'pub':
                ...
                if (this.isBan) {
                  ...
                  emailer.sendMail(this, mailDenunciante, 'Resolución Denuncia',
